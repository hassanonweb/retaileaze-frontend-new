    ...
    >
      ...
      <div className="grid grid-cols-1 gap-12 md:grid-cols-4 md:gap-0">
        ...
        <div className="col-span-2 my-auto px-2">
          <h2 className="relative text-lg font-semibold tracking-tight text-[#27ae5f]">
            An Integrated Platform
            <div className="absolute top-1 -left-[8px] h-5 w-[3px] rounded-r-sm bg-[#27ae5f]" />
          </h2>
          <p className="mt-2 ml-2 text-3xl font-semibold tracking-tighter text-balance text-gray-900 md:text-4xl">
            A single platform for all your retail needs
          </p>
          <p className="mt-4 ml-2 text-balance text-gray-700">
            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed
            malesuada purus nec nunc venenatis, eu ultrices purus aliquet.
                ...
                orbitingObjects={[
                  ...
                  >
                    ...
                    <div
                      ...
                      className="absolute size-10 animate-[ping_7s_ease_infinite] rounded-full ring-1 ring-[#27ae5f]/50"
                    ></div>
                  </div>,
