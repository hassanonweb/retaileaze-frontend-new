import { Home, MapPin, Package, Signal, Truck } from "lucide-react"
...
export const Map = () => {
  return (
    ...
    >
      ...
      <div className="pt-12 text-base font-semibold tracking-tight text-[#27ae5f] sm:pt-20 sm:text-lg">
        Retail Operations
      </div>
      <h2
        id="management-title"
      ...
      >
        Real-time Monitoring & Control for Retail Excellence
      </h2>
      <p className="mt-4 max-w-2xl text-center text-base text-balance text-gray-400 sm:mt-8 sm:text-xl">
        Complete oversight of your retail operations across stores, warehouses,
        and delivery networks, providing real-time insights for inventory
      ...
      <div className="relative mt-20 mb-10 ml-[17rem] scale-90 sm:mb-16 md:mt-24 md:ml-0 md:scale-100">
        ...
        <div className="absolute -top-3 left-[130px]">
          <div className="relative flex items-center justify-center">
            ...
            <MapPin className="relative size-5 text-white" />
            <div className="absolute size-10 animate-[ping_5s_ease_infinite] rounded-full ring-1 ring-blue-500/50"></div>
          </div>
        </div>
        ...
        <div className="absolute top-[73px] left-[243px]">
          <div className="relative flex items-center justify-center">
            ...
            <Package className="relative size-5 text-white" />
            <div className="absolute size-10 animate-[ping_5s_ease_infinite] rounded-full ring-1 ring-blue-500/50"></div>
          </div>
        </div>
        ...
        <div className="absolute top-32 right-[300px]">
          <div className="relative flex items-center justify-center">
            ...
            <Truck className="relative size-5 text-white" />
            <div className="absolute size-10 animate-[ping_5s_ease_infinite] rounded-full ring-1 ring-blue-500/50"></div>
          </div>
        </div>
        ...
        <div className="absolute top-12 right-[430px]">
          <div className="relative flex items-center justify-center">
            <div className="absolute size-10 rounded-full bg-gray-950 ring-1 ring-white/15"></div>
            <div className="absolute -top-4 -right-[5.5rem] flex w-fit items-center justify-center rounded-full bg-gray-950 px-1.5 py-0.5 text-xs whitespace-nowrap text-white ring-1 ring-white/15">
              Distribution Center
            </div>
            <Package className="relative size-5 text-white" />
          </div>
        ...
        <div className="absolute top-9 right-56">
          <div className="relative flex items-center justify-center">
            <Signal className="z-10 size-5 text-white" />
