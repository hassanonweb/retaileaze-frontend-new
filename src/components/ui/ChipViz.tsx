    ...
    <div className="relative flex items-center">
      <div className="relative">
        <motion.div
          ...
          initial="initial"
          animate="animate"
          className="absolute -inset-px z-0 rounded-full bg-linear-to-r from-yellow-500 via-amber-500 to-[#27ae5f] opacity-30 blur-xl"
        />
        <motion.div
          variants={createVariants({ scale: 1.08, delay: 0.1 })}
          initial="initial"
          animate="animate"
          className="relative z-0 min-h-[80px] min-w-[80px] rounded-full border bg-linear-to-b from-white to-green-50 shadow-xl shadow-[#27ae5f]/20"
        >
          <motion.div
            variants={createVariants({ scale: 1.06, delay: 0.2 })}
            initial="initial"
            animate="animate"
            className="absolute inset-1 rounded-full bg-linear-to-t from-yellow-500 via-amber-500 to-[#27ae5f] p-0.5 shadow-xl"
          >
            <div className="relative flex h-full w-full items-center justify-center overflow-hidden rounded-full bg-black/40 shadow-xs shadow-white/40 will-change-transform">
              ...
              <motion.div
                ...
                initial="initial"
                animate="animate"
                className="absolute inset-0 rounded-full bg-linear-to-t from-yellow-500 via-amber-500 to-[#27ae5f] opacity-50 shadow-[inset_0_0_16px_4px_rgba(0,0,0,1)]"
              />
              <motion.div
